...
public class LicenseServiceWebClientTest {
    @Mock
    private LicenseConfiguration licenseServiceConfiguration;
    ...
    void getClientInMemorySize_ReturnsConfiguredValue() {
        ...
        when(licenseServiceConfiguration.getClient()).thenReturn(clientProperties);
        LicenseServiceWebClient webClient = new LicenseServiceWebClient(licenseServiceConfiguration);
